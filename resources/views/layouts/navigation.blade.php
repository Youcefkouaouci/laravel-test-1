    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @else
                    <a href="{{ route('login') }}" class="text-sm text-gray-600 hover:text-gray-900">Se connecter</a>
                    <a href="{{ route('register') }}" class="ml-4 text-sm text-gray-600 hover:text-gray-900">S’inscrire</a>
                @endauth
            </div>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        ...
        @guest
            <div class="pt-4 pb-1 border-t border-gray-200 px-4">
                <a href="{{ route('login') }}" class="block text-sm text-gray-600 hover:text-gray-900">Se connecter</a>
                <a href="{{ route('register') }}" class="block mt-2 text-sm text-gray-600 hover:text-gray-900">S’inscrire</a>
            </div>
        @endguest
    </div>
</nav>
